...
namespace MyLibraryClass
{
    public class Matrix
    {
        ...
        /// <summary>
        /// Метод, вычитающий строку матрицы с заданным индексом из всех строк матрицы.
        /// </summary>
        /// <param name="ind">Индекс строки матрицы, которую нужно вычесть из других строк.</param>
